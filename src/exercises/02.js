...
class Toggle extends React.Component {
  ...
  // this is pretty cool!
  // !IMPORTANT: These methods MUST be static
  // (still not sure why, exactly, maybe that makes them externally available? Or is that how they become prototype properties?)
